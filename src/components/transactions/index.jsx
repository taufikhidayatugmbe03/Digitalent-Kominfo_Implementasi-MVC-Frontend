...
const Transactions = ({ history }) => {
  ...
  const [amountDeposit, setAmountDeposit] = userState("");
  const [descDeposit, setDescDeposit] = userState("");

  const [amountWithdrawal, setAmountWithdrawal] = userState("");
  const [descWithdrawal, setDescWithdrawal] = userState("");

  const [amountTransfer, setAmountTransfer] = userState("");
  const [descTransfer, setDescTransfer] = userState("");
  ...
  const accountTransfer = saldoTotal?.account?.account_number
    ...
    <Container>
      <Tabs>
        ...
        <TabPanel>
          ...
          <Form onSubmit={submiWithdrawalHandler} className="mt-3">
