import { TRANSACTION_SALDO_RESET } from "../constants/transasctionConstants";
import {
...
export const transactionDepositReducer = (state = {}, action) => {
  switch (action.type) {
    ...
    case TRANSACTION_DEPOSIT_SUCCESS:
      return { loading: false, seuccess: true, transaction: action.payload};
...
export const transactionSaldoReducer = (state = { saldoTotal: {}}, action) => {
  switch (action.type) {
    ...
    case TRANSACTION_SALDO_SUCCESS:
      return { loading: false, seuccess: true, saldoTotal: action.payload};
